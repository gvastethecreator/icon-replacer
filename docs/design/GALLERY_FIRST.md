...
The light image defines information architecture and density. The dark image defines the dark palette, Mica/Acrylic treatment, and three-state theme control.
...
- Acrylic is limited to navigation, collection navigation, command surfaces, overlays, and the recent-changes surface.
...
- The app launches only from its normal shortcut. Explorer commands remain a zero-management-window workflow.